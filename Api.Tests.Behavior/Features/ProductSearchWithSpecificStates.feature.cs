...
#line hidden
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "Product Search with Specific States", "    As a Shopper\r\n    I want to research products with specific states (new, used" +
                    ")\r\n    So that I can find the right items based on my preferences", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        public virtual void ShopperSearchesForProductsWithSpecificStates()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Shopper searches for products with specific states", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 7
